...
(
    ...
    `operating_margin`                           decimal(32, 2)                                                DEFAULT NULL,
    `net_margin`                                 decimal(32, 2)                                                DEFAULT NULL,
    `roe`                                        decimal(32, 2)                                                DEFAULT NULL,
    `liabilities_ratio`                          decimal(32, 2)                                                DEFAULT NULL,
    `quick_ratio`                                decimal(32, 2)                                                DEFAULT NULL,
    `reservation_ratio`                          decimal(32, 2)                                                DEFAULT NULL,
    `eps`                                        decimal(32, 2)                                                DEFAULT NULL,
    `per`                                        decimal(32, 2)                                                DEFAULT NULL,
    `bps`                                        decimal(32, 2)                                                DEFAULT NULL,
    `pbr`                                        decimal(32, 2)                                                DEFAULT NULL,
    `dividend`                                   decimal(32, 2)                                                DEFAULT NULL,
    `market_price_dividend`                      decimal(32, 2)                                                DEFAULT NULL,
    `dividend_payout_ratio`                      decimal(32, 2)                                                DEFAULT NULL,
    ...
    `share_of_controlling_shareholder`           bigint                                                        DEFAULT NULL,
    `share_of_non_controlling_shareholder`       bigint                                                        DEFAULT NULL,
    `capital`                                    int                                                           DEFAULT NULL,
    `net_margin_of_controlling_shareholder`      bigint                                                        DEFAULT NULL,
    `number_of_issued_shares`                    bigint                                                        DEFAULT NULL,
